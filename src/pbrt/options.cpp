...
std::string PBRTOptions::ToString() const {
    return StringPrintf(
        ...
        "forceDiffuse: %s useGPU: %s wavefront: %s interactive: %s renderingSpace: %s "
        "nThreads: %s logLevel: %s logFile: %s logUtilization: %s writePartialImages: %s "
        ...
        disableImageTextures, forceDiffuse, useGPU, wavefront, interactive, renderingSpace,
        nThreads, logLevel, logFile, logUtilization, writePartialImages, recordPixelStatistics,
